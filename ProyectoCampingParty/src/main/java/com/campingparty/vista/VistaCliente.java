...
public class VistaCliente extends javax.swing.JFrame {
    ...
    /**
     * Set the current client to display
     */
    public void setCliente(Cliente cliente) {
        this.cliente = cliente;
        if (cliente != null) {
            mostrarNombreCliente();
            mostrarProximaReserva();
        }
    }
    
    /**
     * Display client name in jLabel1
     */
    private void mostrarNombreCliente() {
        if (cliente != null) {
            jLabel1.setText("Hola, " + cliente.getNombre());
        }
    }
    
    /**
     * Display next reservation dates in jLabel3
     */
    private void mostrarProximaReserva() {
        if (cliente != null && cliente.getPrimeraReserva() != null) {
            String fechas = cliente.getPrimeraReserva().getFechasFormato();
            jLabel3.setText(fechas);
        } else {
            jLabel3.setText("No hay reserva próxima");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            vista.setCliente(new Cliente("", "", 0));
