...
import com.campingparty.controlador.*;
...
public class StaffMain extends javax.swing.JFrame {
    ...
    public StaffMain(Staff staff, Modelo modelo, ControladorPrincipal controladorPrincipal) {
        this.staff = staff;
        this.modelo = modelo;
    ...
    /**
     * Configura los listeners de los botones (lógica de navegación)
     */
    private void setupListeners() {
        jButton1.addActionListener(e -> {
            if (controladorPrincipal != null && staff != null) {
                controladorPrincipal.abrirVistaStaffLogNew(staff);
            }
        });

        jButton2.addActionListener(e -> {
            if (controladorPrincipal != null && staff != null) {
                controladorPrincipal.abrirVistaStaffAct(staff);
            }
        });
