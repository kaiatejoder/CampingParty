...
public class VistaClienteModificarReserva extends JFrame {
    ...
    private void inicializarComponentes() {
        ...
        // Deshabilitar la navegación por clic para simular la navegación por botones
        // Se deja habilitado por defecto para la demo visual.
    }
    ...
    private void configurarLayout() {
        ...
        // Título "Nueva reserva" fuera del JTabbedPane (simulando la imagen)
    ...
    /**
     * Crea el contenido de la pestaña "Fecha de la reserva" (image_2ef53b.png).
     */
    private JPanel crearPanelFechas() {
        ...
        JButton btnCalendarioEntrada = new JButton("🗓️"); 
    ...
    /**
     * Crea el contenido de la pestaña "Parcelas" (image_2ef7e5.png).
     */
    ...
    /**
     * Crea el contenido de la pestaña "Miembros" (image_2ef807.png).
     */
    private JPanel crearPanelMiembros() {
        ...
        // Los botones Atrás y Siguiente irían en el panel principal (pero no se muestran en esta imagen)
        
        return panel;
    }
    
    /**
     * Crea el contenido de la pestaña "Confirmación" (image_2ef827.png).
     */
    private JPanel crearPanelConfirmacion() {
        ...
        JLabel labelAsiPerfecto = new JLabel("Sí, así perfecto"); // Puede ser un botón
        JLabel labelNoVolver = new JLabel("No, vuelve atrás"); // Puede ser un botón
        ...
        panel.add(labelAsiPerfecto, gbc);
        
        gbc.gridy = 2;
        panel.add(labelNoVolver, gbc);
