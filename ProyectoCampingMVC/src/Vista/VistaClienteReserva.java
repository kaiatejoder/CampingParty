...
public class VistaClienteReserva extends JFrame {
    ...
    private JPanel crearPanelParcelas() {
        ...
        // Cuadrícula de Parcelas (Simulación de 3x3 para que ocupe menos)
        JPanel panelCuadriculaParcelas = new JPanel(new GridLayout(3, 3, 5, 5));
        for (int i = 0; i < 9; i++) {
    ...
    private JPanel crearPanelMiembros() {
        ...
        // Botones Inferiores (Atrás/Siguiente) no mostrados en la imagen, pero necesarios en el flujo
        JPanel panelBotones = new JPanel(new FlowLayout(FlowLayout.RIGHT, 15, 15));
        JButton btnAtras = new JButton("Atrás");
        JButton btnSiguiente = new JButton("Siguiente");
        panelBotones.add(btnAtras);
