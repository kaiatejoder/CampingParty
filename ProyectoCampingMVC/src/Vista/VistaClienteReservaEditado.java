...
public class VistaClienteReservaEditado extends JFrame {
    ...
    private void inicializarComponentes() {
        labelTitulo = new JLabel("Editar reserva");
    ...
    // =========================================================================
    // Métodos para crear cada Pestaña
    // =========================================================================
    ...
    // Utilidad: cambiar el título ("Editar reserva", "Nueva reserva revisada", etc.)
