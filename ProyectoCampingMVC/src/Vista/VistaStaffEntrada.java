...
public class VistaStaffEntrada extends JFrame {
    ...
    private JButton btnConfirmarEntrada;
    ...
    private JPanel crearPanelFechas() {
        ...
        // 👉 Selector de fecha al pulsar el botón
    ...
    private JPanel crearPanelConfirmacion() {
        ...
        btnConfirmarEntrada = new JButton("Sí, así perfecto");
        ...
        panel.add(btnConfirmarEntrada, gbc);
    ...
    /**
     * Selector de fecha simple con JSpinner. Rellena el JTextField con formato dd/MM/yyyy.
     */
    private void mostrarSelectorFecha(JTextField destino) {
        ...
        // Si ya hay algo en el campo, lo usamos como valor inicial si se puede parsear
    ...
    public JButton getBtnConfirmarEntrada() {
        return btnConfirmarEntrada;
    }
