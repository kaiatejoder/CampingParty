...
public class StaffMain extends JFrame {
    ...
    public StaffMain() {
        ...
        // El controlador se encargará de llamar a setVisible(true)
    }
    ...
    private JPanel crearPanelActividades() {
        ...
        tablaMiDia = new JTable(new MyTableModel(datos, columnas));
    ...
    private JPanel crearPanelCalendario() {
        ...
        for (int i = 1; i <= 30; i++) {
            ...
            dayButton.setPreferredSize(new Dimension(30, 20));
    ...
    // TableModel simple para la tabla "Mi día"
    ...
    public JButton getBtnAdministrarReservas() {
        return btnAdministrarReservas;
    }

    public JButton getBtnCambiarDescuento() {
        return btnCambiarDescuento;
    }

    public JPanel getPanelCuadriculaEstado() {
        return panelCuadriculaEstado;
    }
    ...
    public JTable getTablaMiDia() {
        return tablaMiDia;
    }

    /** Permite al controlador cambiar el contenido de la tabla "Mi día". */
    public void setModeloMiDia(TableModel modelo) {
        tablaMiDia.setModel(modelo);
    }
}
